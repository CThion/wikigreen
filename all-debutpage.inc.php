  ...
  <header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        <img src="images/logo/logo-wikigreen/logo-1/logo.png" alt="" width="350" height="300" /> <a class="navbar-brand" href="#">
          <span class="navbar-brand mb-0 h1">Pour une meilleure information de l'écologie </span>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="d-flex flex-column bd-highlight mb-3">
              ...
              <div class="p-2 bd-highlight"><label for="exampleFormControlInput1" id="test2" class="form-label">Veuillez renseigner votre adresse mail : </label>
                <input type="email" id="test" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
              </div>
              <div class="p-2 bd-highlight">Mot de passe : </div>
              <div class="p-2 bd-highlight">Connexion</div>
            </div>
          </div>
      </div>
    </nav>
