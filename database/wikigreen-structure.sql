...
--
-- Structure de la table `art_typeart`
--

CREATE TABLE `art_typeart` (
  `id` int(11) NOT NULL,
  `id_art` int(11) NOT NULL,
  `id_typeart` int(11) NOT NULL
...
--
-- Structure de la table `ref_typeref`
--

CREATE TABLE `ref_typeref` (
  `id` int(11) NOT NULL,
  `id_ref` int(11) NOT NULL,
...
--
-- Structure de la table `typeref`
--

CREATE TABLE `typeref` (
  `id` int(11) NOT NULL,
  `id_ref` int(11) NOT NULL,
  `id_typeref` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='table de jointure entre ref et typeref';
...
--
-- Index pour la table `art_typeart`
--
ALTER TABLE `art_typeart`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_art` (`id_art`,`id_typeart`),
  ADD KEY `id_typeinfo` (`id_typeart`);
...
--
-- Index pour la table `ref_typeref`
--
ALTER TABLE `ref_typeref`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `typeart`
--
ALTER TABLE `typeart`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `typeref`
--
ALTER TABLE `typeref`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `art_typeart`
--
ALTER TABLE `art_typeart`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `ref_typeref`
--
ALTER TABLE `ref_typeref`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `typeart`
--
ALTER TABLE `typeart`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `typeref`
--
ALTER TABLE `typeref`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Contraintes pour la table `art_typeart`
--
ALTER TABLE `art_typeart`
  ADD CONSTRAINT `art_typeart_ibfk_1` FOREIGN KEY (`id_art`) REFERENCES `art` (`id`),
  ADD CONSTRAINT `art_typeart_ibfk_2` FOREIGN KEY (`id_typeart`) REFERENCES `typeart` (`id`);
...
--
-- Contraintes pour la table `ref_typeref`
--
ALTER TABLE `ref_typeref`
  ADD CONSTRAINT `ref_typeref_ibfk_1` FOREIGN KEY (`id_ref`) REFERENCES `ref` (`id`),
  ADD CONSTRAINT `ref_typeref_ibfk_2` FOREIGN KEY (`id_reftype`) REFERENCES `typeart` (`id`);
